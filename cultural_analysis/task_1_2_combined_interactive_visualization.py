...
- Filtering options for spam/non-spam comments
...
<body>
    ...
    <div class="stats-grid">"""
        ...
        if task2_yearly is not None:
            ...
            despacito_total = task2_yearly[task2_yearly['Song'] == 'Despacito']['Total_Comments'].sum()
            seeyou_total = task2_yearly[task2_yearly['Song'] == 'See You Again']['Total_Comments'].sum()
    ...
    def generate_summary_statistics(self):
        ...
        if self.task1_data is not None:
            summary_stats['Task1'] = {
                ...
                'years_covered': list(self.task1_data['Year'].unique()),
                'top_countries_despacito': self.task1_data[self.task1_data['Video'] == 'Despa']['Top 1 Country'].tolist(),
                'top_countries_seeyou': self.task1_data[self.task1_data['Video'] == 'Seeyou']['Top 1 Country'].tolist()
            }
        ...
        if self.task2_data is not None:
            ...
            # Yearly breakdown
            if task2_yearly is not None:
                summary_stats['Task2']['yearly_breakdown'] = task2_yearly.to_dict('records')
